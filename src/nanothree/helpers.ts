...
export class CameraHelper {
  ...
  update() {
    ...
    const positions = new Float32Array([
      -nearW,  nearH, -near,  // 0: near top-left
       nearW,  nearH, -near,  // 1: near top-right
       nearW, -nearH, -near,  // 2: near bottom-right
      -nearW, -nearH, -near,  // 3: near bottom-left
      -farW,   farH,  -far,   // 4: far top-left
       farW,   farH,  -far,   // 5: far top-right
       farW,  -farH,  -far,   // 6: far bottom-right
      -farW,  -farH,  -far,   // 7: far bottom-left
       0,      0,      0,     // 8: camera origin (for cross)
    ])
...
export class DirectionalLightHelper {
  ...
  constructor(private light: DirectionalLight, private size = 5) {
    // Square plane
    const s = size / 2
  ...
  update() {
    ...
    const lx = this.light.position.x, ly = this.light.position.y, lz = this.light.position.z
